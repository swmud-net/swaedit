...
do
	if [ -d $i ]; then
		...
		mv artifact $aid
		$jar cMf $aid.jar $aid
		$mvn install:install-file -Dfile=$aid.jar -DgroupId=com.trolltech.qtjambi -DartifactId=$aid -Dversion=$version -Dpackaging=jar -DgeneratePom=true -DcreateChecksum=true -DupdateReleaseInfo=true
		rm -rf $aid $aid.jar
...
$mvn install:install-file -Dfile=$qtjambijar -DgroupId=com.trolltech.qtjambi -DartifactId=qtjambi -Dversion=$version -Dpackaging=jar -DgeneratePom=true -DcreateChecksum=true -DupdateReleaseInfo=true
